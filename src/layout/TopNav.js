      ...
      <header className="header" id="site-header">
        ...
        <div className="header-content-wrapper">
          ...
          <div className="control-block">
                ...
                <div className="mCustomScrollbar" data-mcs-theme="dark">
                  <ul className="notification-list friend-requests">
                    ...
                    <li className="accepted">
                      ...
                      <div className="more">
                        <svg className="olymp-three-dots-icon"></svg>
                        <svg className="olymp-little-delete"></svg>
                      </div>
                    </li>
            ...
            <div className="control-icon more has-items">
              <svg className="olymp-thunder-icon"></svg>
                ...
                <div className="mCustomScrollbar" data-mcs-theme="dark">
                  <ul className="notification-list">
                    <li>
                      ...
                      <span className="notification-icon">
                        <svg className="olymp-comments-post-icon"></svg>
                      </span>
                    ...
                    <li>
                      ...
                      <span className="notification-icon">
                        <svg className="olymp-heart-icon"></svg>
                      </span>
            ...
            <div className="author-page author vcard inline-items more">
                  ...
                  <div className="mCustomScrollbar" data-mcs-theme="dark">
                    ...
                    <ul className="account-settings">
                      <li>
                        <a href="29-YourAccount-AccountSettings.html">
                          <svg className="olymp-menu-icon"></svg>
                      ...
                      <li>
                        <a href="#">
                          <svg className="olymp-logout-icon"></svg>
                    ...
                    <form className="form-group with-button custom-status">
                      ...
                      <button className="bg-purple">
                        <svg className="olymp-check-icon"></svg>
                      </button>
                    </form>
              ...
              <a href="02-ProfilePage.html" className="author-name fn">
                <div className="author-title">
                  James Spiegel <svg className="olymp-dropdown-arrow-icon"></svg>
                </div>
